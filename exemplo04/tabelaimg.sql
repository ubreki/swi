...
INSERT INTO `tabelaimg` (`codigo`, `produto`, `descricao`, `data`, `valor`, `imagem`) VALUES
(102030, 'Horizon - Zero Dawn - PS4', 'Em um mundo aberto, exuberante, vibrante e pós-apocalíptico, criaturas mecanizadas colossais vagam por uma paisagem fora do controle da humanidade.Ao longo do tempo, a evolução humana regrediu para uma existência tribal de caça e colheita ...', '2017-05-01', '199.29', 'ZeroDawn.png'),
